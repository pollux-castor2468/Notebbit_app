...
export default function DocumentEditor() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* 5. Colors Dialog (Text & Bg) */}
      {(activeModal === 'colors' || activeModal === 'bgColors') && (
        <Modal transparent animationType="fade" visible={true} onRequestClose={() => setActiveModal(null)}>
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={layoutStyles.rowBetween}>
                <Text style={[textStyles.h3, { marginBottom: 16 }]}>
                  {activeModal === 'colors' ? "選擇字體顏色" : "選擇背景顏色"}
                </Text>
                <Pressable onPress={() => setActiveModal(null)} style={{ padding: 4, marginBottom: 16 }}>
              ...
              {isHexMode ? (
                <View style={{ marginBottom: 16 }}>
                  <Text style={[textStyles.body, { marginBottom: 8 }]}>Hex 色碼</Text>
                  <View style={[layoutStyles.rowCenter, { gap: 8 }]}>
                    <TextInput
                    ...
                    />
                    <Pressable
                      style={[styles.saveBtn, { height: 44, paddingVertical: 0, justifyContent: 'center' }]}
                      onPress={handleApplyHex}
                    >
                      <Text style={styles.saveBtnText}>套用</Text>
                    </Pressable>
                  </View>
                  ...
                  <Pressable
                    ...
                    style={{ marginTop: 16 }}
                  >
                    <Text style={{ color: colors.text, textDecorationLine: 'underline' }}>返回色票選擇</Text>
                  </Pressable>
                </View>
              ) : (
                <View>
                  ...
                  <View style={styles.colorRow}>
                    {circleColors[0].map((color, index) => (
                      <Pressable
                        key={`circle1-${index}`}
                        style={[
                          styles.colorCircle,
                  ...
                  <View style={[styles.colorRow, { marginTop: 12 }]}>
                    {circleColors[1].map((color, index) => {
                      if (color === null) {
                        return (
                          <Pressable
                            key={`circle2-plus`}
                            style={styles.colorPlusBtn}
